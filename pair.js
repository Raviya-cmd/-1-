...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '👻 ᴄᴏɴᴇᴄᴛᴇᴅ ʀᴀᴠɪʏᴀ-ᴍᴅ ꜰʀᴇᴇ ʙᴏᴛ',
        `📞 Number: ${number}\n🩵 Status: Connected`,
        'ᴘᴀᴏᴡᴇʀᴅ ʙʏ ɴᴏᴡᴛʏ ʀᴀᴠɪʏᴀ'
    );
        ...
        },
        {
            ...
            nativeFlowInfo: {
                ...
                paramsJson: JSON.stringify({
                    ...
                    sections: [
                        {
                            title: `ʀᴀᴠɪʏᴀ-ᴍᴅ ꜰʀᴇᴇ ʙᴏᴛ`,
                            highlight_label: '',
                            rows: [
                                {
                                    title: 'MENU 📌',
                                    description: 'ᴘᴏᴡᴇʀᴅ ʙʏ ʀᴀᴠɪʏᴀ -ᴍᴅ',
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://i.ibb.co/TDgzTB29/SulaMd.png" },
        caption: `ʀᴀᴠɪʏᴀ-ᴍᴅ ꜰʀᴇᴇ ʙᴏᴛ ʟɪꜱᴛ ᴍᴇɴᴜ\n\n${captionText}`,
    }, { quoted: msg });
    ...
    const ownerName = 'ɴᴏᴡᴛʏ ʀᴀᴠɪʏᴀ';
    const organization = '*ʀᴀᴠɪʏᴀ-ᴍᴅ* WHATSAPP BOT DEVALOPER 🍬';
  ...
  break;
    ...
    break;
                ...
                case 'ai': {
                    ...
                    if (!q || q.trim() === '') {
                        return await socket.sendMessage(sender, { text: "ඕ කියන්න අනේ් මම ʀᴀᴠɪʏᴀ ᴀɪ🤭" }, { quoted: msg });
                    }

                    const prompt = `ඔබගේ නම ʀᴀᴠɪʏᴀ ᴀɪ.  
        ...
        socket.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'open') {
                try {
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'ʀᴀᴠɪʏᴀ-ᴍɪɴɪ ᴍᴀɪɴ'}`);
                }
            }
        });
    } catch (error) {
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '💥ʀᴀᴠɪʏᴀ ᴍᴅ ꜰʀᴇᴇ ʙᴏᴛ ɪꜱ ʀᴜɴɴɪɴɢ💥',
